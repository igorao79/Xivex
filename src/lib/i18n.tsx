...
const translations = {
  ru: {
    ...
    modeAnalysis: "Анализ",
    modeChat: "Чат",
    modePrompting: "Промптинг",
    // Prompting
    promptTitle: "AI-генератор промптов",
    promptEmpty: "Ответьте на вопросы, чтобы ИИ создал лучший промпт",
    promptEmptyHint: "ИИ задаст уточняющие вопросы и создаст профессиональный промпт",
    promptPlaceholder: "Опишите задачу, для которой нужен промпт...",
    promptGenerate: "Сгенерировать промпт",
    promptClarifying: "Уточняющие вопросы",
    promptContinue: "Продолжить",
    promptSkip: "Пропустить",
    promptGenerating: "Генерация промпта...",
    promptResult: "Ваш промпт",
    promptDownload: "Скачать .md",
    promptCopy: "Копировать",
    promptStartOver: "Начать заново",
    promptUploadFile: "Или загрузите .txt / .md файл",
    // Agent chat
  ...
  en: {
    ...
    promptEmpty: "Answer the questions so AI can create a better prompt",
    promptEmptyHint: "AI will ask clarifying questions and create a professional prompt",
    promptPlaceholder: "Describe the task you need a prompt for...",
    promptGenerate: "Generate prompt",
    promptClarifying: "Clarifying questions",
    promptContinue: "Continue",
    promptSkip: "Skip",
    promptGenerating: "Generating prompt...",
    promptResult: "Your prompt",
    promptDownload: "Download .md",
    promptCopy: "Copy",
    promptStartOver: "Start over",
    promptUploadFile: "Or upload a .txt / .md file",
    // Agent chat
